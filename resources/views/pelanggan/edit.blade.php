    ...
    <main>
        <div class="container py-4">
			...
			<form action="/pelanggan/update" method="post">
                    ...
                    <input type="text" required="required" name="username" value="{{ $p->username }}" class="form-control" />
						<label class="form-label">Username Pelanggan</label>
					</div>

					<!-- Text input -->
					<div class="form-outline mb-4">
                    <input type="text" required="required" name="password" value="{{ $p->password }}" class="form-control" />
						<label class="form-label">Password Pelanggan</label>
					</div>

					<div class="form-outline mb-4">
                    <input type="text" required="required" name="nometer" value="{{ $p->nometer }}" class="form-control" />
