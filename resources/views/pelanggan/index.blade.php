                    ...
                    <table class="table table-striped table-sm">
                        ...
                        @foreach ($pelanggans as $pelanggan)
                            <tr class="mode">
                                ...
                                <a href="{{ route('pelanggan.read', $pelanggan->id) }}" class="btn btn-success">Lihat</a>
                                <a class="btn btn-primary" href="{{ route('pelanggan.update', $pelanggan->id) }}">Edit</a>
                                <a class="btn btn-danger" href="/pelanggan/hapus/{{ $pelanggan->id }}">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
